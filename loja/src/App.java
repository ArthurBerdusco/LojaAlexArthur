...
public class App {
    ...
    private static void runTest() {
        ...
        var produto2 = new Produto(2, "Celular", "Iphone 11", 3500, 3);
        var produto3 = new Produto(3, "PS5", "Spider", 4300, 6);
        var produto4 = new Produto(4, "Tablet", "Samsung", 2500, 8);
        var produto5 = new Produto(5, "Notebook", "Dell", 1300, 11);
